...
type RawMaterialScreenRouteProp = RouteProp<RootStackParamList, 'RawMaterial'>;

function RawMaterialScreen(): JSX.Element {
  const route = useRoute<RawMaterialScreenRouteProp>();
  ...
  if (!params) {
    return (
      <View style={styles.container}>
        <Text>Please scan a barcode to view raw material details</Text>
      </View>
    );
  }
    ...
    <ScrollView style={styles.container}>
      <View style={styles.card}>
        <View style={styles.header}>
          <Text style={styles.headerText}>Raw Material Details</Text>
